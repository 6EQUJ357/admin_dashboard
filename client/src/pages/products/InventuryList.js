                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 className="mb-sm-0">Inventury List</h4>

                                <div className="page-title-right">
                                    <ol className="breadcrumb m-0">
                                        <li className="breadcrumb-item"><a href="">Inventury</a></li>
                                        <li className="breadcrumb-item active">Inventury List</li>
                                    </ol>
                                </div>
                                            ...
                                            <tbody >
                                                ...
                                                {currentItems.length > 0 && 
                                                 <tr style={{fontWeight:"bolder", fontSize:"1rem"}}>
                                                    <td>Total</td>
                                                    <td></td>
                                                    <td>{currentItems.map(list=>list.productWeight).reduce((a,b)=> (Number(a)+ Number(b)))}</td> 
                                                    <td>{currentItems.map(list=>list.inStock).reduce((a,b)=> (Number(a)+ Number(b)))}</td>  
                                                    <td>{(currentItems.map(list=> (list.inStock) * (list.productPrice)).reduce((a,b)=> Number(a) + Number(b)))}</td>  
                                                    <td></td>
