...
import { getProductData, DeleteProductData} from '../products/productService/productService';
            ...
            <div className="page-content">
                <div className="container-fluid">
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 className="mb-sm-0">Quotation List</h4>
                    ...
                    <div className="row pb-4 gy-3">
                            ...
                            <Link to="/addquotation" className="btn btn-primary addtax-modal"><i className="las la-plus me-1"></i> Add Quotation</Link>
                            </div>
                        ...
                        <div className="col-sm-auto ms-auto">
                           <div className="d-flex gap-3">
                            <div className="search-box">
                                <input type="text" className="form-control" id="searchMemberList" placeholder="Search for Quotation No." name="searchProducts" value={searchproduct} onChange={(e)=>setSearchproduct(e.target.value)}/>
